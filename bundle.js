 ...
 */
const { diagnose } = require(1);
const translate = require(23);
const ui = require(25);
const terms = require(24);
...
const { getFullGanZhi } = require(2)
const { fullAnalysis } = require(5)
const { runBaGangDiagnosis } = require(6)
const tangTouDB = require(16)
const { calcDynamicYuDian } = require(17)
const { calcFullYunQi } = require(20)
const { getKeYun, getKeQiMainAux, ZHUYUN_SEQ } = require(21)
const { liuqiDatabase } = require(22)
...
const {Solar, Lunar, Foto, Tao, NineStar, EightChar, SolarWeek, SolarMonth, SolarSeason, SolarHalfYear, SolarYear, LunarMonth, LunarYear, LunarTime, ShouXingUtil, SolarUtil, LunarUtil, FotoUtil, TaoUtil, HolidayUtil, NineStarUtil, I18n} = require(4)
...
const { parseSymptom } = require(7);
const { baGangMerge } = require(12);
const { generateZhifa } = require(14);
...
const wangMap = require(8);
const wenMap = require(9);
const wenZhengMap = require(10);
const qieMap = require(11);
...
const { calcDynamicYuDian } = require(18);
